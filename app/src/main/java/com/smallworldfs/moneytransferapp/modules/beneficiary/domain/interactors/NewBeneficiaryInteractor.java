...
public interface NewBeneficiaryInteractor extends Interactor {

    interface NewBeneficiaryCallback {
        ...
        void getBeneficiaryFormReceived(FormData formData, Pair<String, String> selectedCountry);
