...
import com.smallworldfs.moneytransferapp.modules.beneficiary.presentation.presenter.implementation.EditBeneficiaryPresenterImpl;
...
@AndroidEntryPoint
public class EditBeneficiaryActivity extends GenericActivity implements EditBeneficiaryPresenter.View {

    private static final String TAG = EditBeneficiaryActivity.class.getSimpleName();

    public static final String BENEFICIARY_EXTRA = "BENEFICIARY_EXTRA";
    public static final String BENEFICIARY_DETAIL = "BENEFICIARY_DETAIL";
    ...
    private EditBeneficiaryPresenterImpl mPresenter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Beneficiary beneficiary = getIntent().getParcelableExtra(BENEFICIARY_DETAIL);

        mPresenter = new EditBeneficiaryPresenterImpl(AndroidSchedulers.mainThread(), Schedulers.io(), this, this, this, Objects.requireNonNull(beneficiary), beneficiary.getBeneficiaryType() != null ? beneficiary.getBeneficiaryType() : "");
        mPresenter.create();
    ...
    public void configureView() {
        ...
        ((StyledTextView) mToolbar.findViewById(R.id.left_title)).setText(getString(R.string.edit_beneficiary_title));
    ...
    public void completeStep(Step step) {
        ...
        if (view != null) {
            ...
            if (!step.getStepType().equalsIgnoreCase(Constants.STEP_TYPE.DELIVERY_METHOD)) {
                ...
                sendButton.setContentDescription("send_money_button");
                sendButton.setText(getString(R.string.done_action));
            ...
            case Constants.STEP_TYPE.FORM: {
                ...
                if (!enable) {
                    ...
                    try {
                        ...
                        Log.e(TAG, "enableDisableEditTextListeners:e:-------------------------", e);
                    }
                }
                break;
            }
                ...
                case Constants.STEP_TYPE.FORM:
                    ...
                    if (recyclerView != null) {
                        ...
                        try {
                            ...
                            Log.e(TAG, "updateComboGroupValueData:e:---------------------------", e);
                        }
                    }
                    break;
            }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == REQUEST_CONTACTS_PERMISSION_CODE) {// If request is cancelled, the result arrays are empty.
    ...
    public void setSelectedDeliveryMethod(Method deliveryMethod) {
        if (mContentStepManager != null) {
            mContentStepManager.setSelectedDeliveryMethod(deliveryMethod);
        }
    }

    @Override
    public void showDeliveryMethodChangeWarning() {
        new DialogExt().showDoubleActionGeneralDialog(this, getString(R.string.edit_beneficiary_change_delivery_method_dialog_title),
                getString(R.string.edit_beneficiary_change_delivery_method_dialog_content),
                getString(R.string.accept_text),
                () -> {
                    mPresenter.userChoisedCreateNewBeneficiary();
                    ((StyledTextView) mToolbar.findViewById(R.id.left_title)).setText(getString(R.string.new_beneficiary_title));
                },
                getString(R.string.cancel),
                () -> mPresenter.userChoisedNotToCreateNewBeneficiary());
    }

    @Override
    public void backToPreviousScreenWithResultOK(Beneficiary beneficiary, int code) {
        Intent returnIntent = new Intent();
        returnIntent.putExtra(BENEFICIARY_EXTRA, (Parcelable) beneficiary);
        this.setResult(code, returnIntent);
        finish();
    }
}
