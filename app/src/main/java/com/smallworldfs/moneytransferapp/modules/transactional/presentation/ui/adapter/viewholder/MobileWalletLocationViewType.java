...
public class MobileWalletLocationViewType extends RecyclerView.ViewHolder {

    public RelativeLayout cellBackground;
    public StyledTextView feeIncludedValue, rateValue, timeDelivery, iofAmount;
    public StyledTextView bankName;
    public View iofSeparator;

    public MobileWalletLocationViewType(View itemView) {
        super(itemView);
    ...
    public void styleLocationCell(Drawable cellLocationContainerBackground, int textColorValue, int separatorColor,
                                  int iofColor) {
        ...
        this.timeDelivery.setTextColor(textColorValue);
